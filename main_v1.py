...
class ReportGenerator:
    ...
    def _collect_availability_data(self, all_hosts, period, sla_goal):
        ...
        <div class="kpi-box-single">
            ...
            <div class="kpi-label">Média de SLA ({len(hosts_for_sla)} Hosts)</div>
        ...
        <div class="kpi-box-single"><div class="kpi-value">{df_sla[df_sla['SLA (%)'] < 99.9].shape[0]}</div><div class="kpi-label">Hosts com SLA &lt; 99.9%</div></div>
        <div class="kpi-box-single"><div class="kpi-value">{len(all_problems)}</div><div class="kpi-label">Total de Incidentes</div></div>
        <div class="kpi-box-single"><div class="kpi-value" style="font-size: 18pt;">{principal_ofensor}</div><div class="kpi-label">Principal Ofensor</div></div>
        """
